...
from collective.mailinglijst.browser import portlet as mailinglijst
...
class TestPortlet(unittest.TestCase):
    ...
    def testPortletTypeRegistered(self):
        portlet = getUtility(IPortletType, name='portlet.Mailinglijst')
        self.assertEquals(portlet.addview, 'portlet.Mailinglijst')
    ...
    def testInvokeAddview(self):
        ...
        self.failUnless(isinstance(mapping.values()[0], mailinglijst.Assignment))
    ...
    def testRenderer(self):
        ...
        assignment = mailinglijst.Assignment(name="foo")

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment),
            IPortletRenderer)
        self.failUnless(isinstance(renderer, mailinglijst.Renderer))
...
class TestRenderer(unittest.TestCase):
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or mailinglijst.Assignment(
...
class TestPortletIntegration(unittest.TestCase):
    ...
    def test_add_portlet_form(self):
        self.browser.open(
            self.portal_url +
            "/++contextportlets++plone.leftcolumn/+/portlet.Mailinglijst"
        )

        self.assertTrue("Add Mailinglijst Portlet" in self.browser.contents)
    ...
    def test_add_portlet(self):
        ...
        self.assertTrue("Mailinglijst" in self.browser.contents)
    ...
    def test_edit_portlet(self):
        ...
        self.browser.open(
            self.portal_url +
            "/++contextportlets++plone.leftcolumn/mailinglijst/edit"
        )
