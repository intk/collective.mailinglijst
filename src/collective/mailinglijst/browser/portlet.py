...
from collective.mailinglijst.browser.newsletter import NewsletterSubscriberForm


class IMailinglijstPortlet(IPortletDataProvider):
    ...
    available_lists = schema.List(
        ...
        value_type=schema.Choice(
            source='collective.mailinglijst.vocabularies.AvailableLists'
        )
    )


class Assignment(base.Assignment):
    implements(IMailinglijstPortlet)
...
class Renderer(base.Renderer):
    ...
    def _data(self):
        ...
        return catalog(portal_type='Mailinglijst Item')
...
class EditForm(EditForm):
    fields = field.Fields(IMailinglijstPortlet)
    fields['available_lists'].widgetFactory = CheckBoxFieldWidget
    label = _(u"Edit Mailinglijst Portlet")
    description = _(
        u"This portlet displays a subscription form for a " +
        u"Mailinglijst newsletter.")
